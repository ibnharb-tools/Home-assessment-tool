    ...
    <>
      ...
      <main className="flex-1">
        <section className="mx-auto max-w-[1200px] px-6 pt-32 pb-12 md:px-8 md:pt-36">
          ...
          <h1 className="mt-4 max-w-[20ch] font-display text-5xl font-extrabold leading-[1.04] tracking-[-0.02em] md:text-6xl">
            What we&apos;re building next
          </h1>
          <p className="mt-6 max-w-[60ch] text-lg text-ink-soft">
            Everstead today gives you a complete clean-energy assessment. Here&apos;s
            where we&apos;re taking it — from real-world validation to a full path
            from plan to installed system.
          </p>
        </section>
        ...
        <section className="mx-auto max-w-[1200px] px-6 pb-28 md:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3">
            {roadmap.map((item) => (
              <div
                key={item.title}
                className="flex flex-col gap-3 border-t border-line py-8 pr-4"
              >
